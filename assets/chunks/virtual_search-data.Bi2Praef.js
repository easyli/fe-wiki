...
&lt;!DOCTYPE html&gt;
&lt;html&gt;
  &lt ...`,l:"frontEnd/html5/base/index.html#html-的基本结构",a:"html-的基本结构"},"74.2":{t:"HTML 标签和元素",p:"HTML 标签用于定义网页的结构和内容，它们由尖括号包围。标签通常成对出现，包含开始标签和结束标签，例如&lt;tagname&gt;内容&lt;/tagname&gt;。有些标签是空标签，没有结束标 ...",l:"frontEnd/html5/base/index.html#html-标签和元素",a:"html-标签和元素"},"74.3":{t:"HTML5 的新特性",p:"HTML5 引入了许多新特性，如语义化标签（&lt;header&gt;、&lt;footer&gt;、&lt;nav&gt;、&lt;article&gt;等）、多媒体支持（&lt;video&gt ...",l:"frontEnd/html5/base/index.html#html5-的新特性",a:"html5-的新特性"},"74.4":{t:"实践和进阶",p:`学习 HTML 最重要的是通过实践来加深理解。创建简单的网页、布局、添加样式和图像，然后逐渐增加复杂性，学习如何使用 CSS 和 JavaScript 与 HTML 结合，从而实现更丰富的用户体验。
 ...`,l:"frontEnd/html5/base/index.html#实践和进阶",a:"实践和进阶"},"75.0":{t:"# 常用标签及用法",p:`当描述 HTML 标签时，代码块会被渲染成 HTML 标记，为了避免这种情况，我将在每个代码示例中添加特殊字符，以确保它们不会被渲染。请在复制代码时将特殊字符删除。
