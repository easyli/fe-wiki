...
export default {
  ...
  markdown: {
    ...
    config: (md) => {
      md.use(MarkdownItGitHubAlerts, {
        markers: '*',
        icons: DEFAULT_GITHUB_ICONS,
        titles: { tip: '注意', note: '注释', important: '重要', warning: '警告', caution: '小心' },
        matchCaseSensitive: true,
      })
    },
  },
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/easyli' }],

    // 页脚配置
    footer: {
      message: "easyli's wiki.",
      copyright: 'Copyright © 2024-present easyli',
    },
    docFooter: {
      prev: '上一篇',
      next: '下一篇',
